(function (constants, globals) {
	...
	var require$$0 = /*@__PURE__*/getAugmentedNamespace(browser$1);
	...
	Object.defineProperty(Textfit$1, "__esModule", {
	    value: true
	});
	...
	Textfit$1.default = TextFit;

	Object.defineProperty(lib, "__esModule", {
	  value: true
	});
	var Textfit = lib.Textfit = undefined;

	var _Textfit = Textfit$1;

	var _Textfit2 = _interopRequireDefault(_Textfit);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	Textfit = lib.Textfit = _Textfit2.default;
	...
	var OpenGraphImage = function OpenGraphImage() {
	  return /*#__PURE__*/React.createElement(Container, null, /*#__PURE__*/React.createElement(Content, null, /*#__PURE__*/React.createElement("h1", null, /*#__PURE__*/React.createElement(Textfit, {
	    max: 256,
	    min: 24,
	    style: {
	      maxHeight: "80%",
	  ...
	  }, "Being a software enginner is not all it\u2019s cut out to be.")), /*#__PURE__*/React.createElement(ContentMeta, null, /*#__PURE__*/React.createElement(Tags, null, /*#__PURE__*/React.createElement("li", null, "life"), /*#__PURE__*/React.createElement("li", null, "career"), /*#__PURE__*/React.createElement("li", null, "web_dev")), /*#__PURE__*/React.createElement("p", null, "@ChinonsoEmmanuel"))));
	};

	var Container = styled.section.withConfig({
	  displayName: "OpenGraphImage__Container",
	  componentId: "sc-le7n5x-0"
	})(["width:calc(1200px);height:calc(630px);background-image:", ";padding:40px;display:flex;box-shadow:2.8px 2.8px 2.2px rgba(0,0,0,0.02),6.7px 6.7px 5.3px rgba(0,0,0,0.028),12.5px 12.5px 10px rgba(0,0,0,0.035),22.3px 22.3px 17.9px rgba(0,0,0,0.042),41.8px 41.8px 33.4px rgba(0,0,0,0.05),100px 100px 80px rgba(0,0,0,0.07);overflow:hidden;", ""], constants.COLORS.linearGradient, globals.injectGlobalStyles);
	...
	var ContentMeta = styled.div.withConfig({
	  displayName: "OpenGraphImage__ContentMeta",
	  componentId: "sc-le7n5x-3"
	})(["display:flex;justify-content:space-between;font-size:24px;"]);
	reactDom.exports.render( /*#__PURE__*/React.createElement(OpenGraphImage, null), (_document = document) === null || _document === void 0 ? void 0 : _document.getElementById("root"));
